...
export default function Left() {
    return (
        ...
        <div className="col-12 col-sm-6 col-md-2 left ">
            <div className='justify-content-between pt-3 d-flex text-light'>
            ...
            <div className='left-bottom-box container-fluid p-0'>
                <div className="row d-flex p-0">
                    ...
                    <div className="col-6"> <button className='left-bottom-box-btn2'>Buy $XYZ</button></div>
                </div>
                <div className="row d-flex p-0 mt-3">
                    <div className="input-group mb-3 rounded-pill">
                        <button className="btn btn-outline-primary border-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                fill="currentColor" className="bi bi-globe globe-icon" viewBox="0 0 16 16">
                        ...
                        <input type="text" id='input-bottom' className="form-control"
                            placeholder="😂"
