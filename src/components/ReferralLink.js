    ...
    return (
        <div className='referral-link-col'>
            <div>
                ...
                <span className='fee-span'>12.5% of fee</span>
            </div>
            <div className='mt-2'>
                <span className='linkforxyz'>Your Referral Link for XYZ</span>
                <div className="input-group">
                    <input type="text" className='link-input form-control' defaultValue={link} />
