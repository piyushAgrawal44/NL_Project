        ...
        <div className="col-12 col-sm-6 order-sm-2 order-md-4 col-md-3 right px-3 py-4 text-light">
            <div className="row">
                <div className="col-auto">
                    <div class="dropdown">
                        <button class="btn btn-avalanche dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div className="row mt-3">
                <div className="col-auto text-light">
                    ...
                    <span class="cos_link">Coustom link</span>
                </div>
            </div>
